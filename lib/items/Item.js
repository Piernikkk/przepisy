...
import { IconCalendar, IconCalendarOff, IconCategory, IconClock, IconPlayerPlay, IconStairs, IconTrophy } from "@tabler/icons-react";
...
export default function Item({ name, desc, img, time, ...props }) {
